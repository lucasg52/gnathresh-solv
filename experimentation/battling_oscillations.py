...
#plotting
plt.plot(t,prop_v0,label="prop 0", marker = '-')
plt.plot(t, prop_v00625, label = "prop 0.0625", marker ='-')
plt.plot(t,main_v1,label="main 1", marker ='-')
plt.plot(t,main_v0,label="main 0")
plt.plot(t,IS_v1,label="IS 1", marker ='-')
plt.plot(t,soma_v0,label="soma 0",marker ='-')
plt.legend()
plt.grid()
plt.show()
