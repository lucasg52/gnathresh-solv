...
def run(stim_len, dau_len, rin_solver, title):
    ...
    for i in lengths:
        ...
        gna_base.append(fullsolve_m(50))
        # print(f"equiv: gna = {fullsolve_n(53)}")
        gna_eqi.append(fullsolve_n(50))
        gna_eqi2.append(fullsolve_w(50))
    m.side1.disconnect()
    n.side1.disconnect()
    w.side1.disconnect()
    print(f"Control: gna base = {fullsolve_m(50)}")
    print(f"Control: gna equiv = {fullsolve_n(50)}")
    print(f"Control: gna equiv 2 = {fullsolve_w(50)}")
